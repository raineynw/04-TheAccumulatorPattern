...
def run_test_factorial():
    ...
    #TEst 3:
    answer_from_oracle = math.factorial(46578)
    answer_from_my_code = factorial(46578)
    ...
    #TEst 5:
    answer_from_oracle = math.factorial(2138)
    answer_from_my_code = factorial(2138)
...
def run_test_count_cosines_from():
    ...
    #Test 3:
    expected = 2
    answer = count_cosines_from(4, 5, 0.29)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    #Test 4:
    expected = 2
    answer = count_cosines_from(12, 30, 0.29)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    #Test 5:
    expected = 2
    answer = count_cosines_from(-1, 10, 0.29)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    #TEst 6:
    expected = 2
    answer = count_cosines_from(-10, 9, 0.29)
...
def run_test_sum_unit_fractions_from():
    ...
    #Test 2:
    expected = 0.27424  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(10, 12)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    #Test 3:
    expected = 2.8289  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 9)
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    #Test 4:
    expected = 1.9289  # This is APPROXIMATELY the correct answer.
